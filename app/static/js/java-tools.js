...
$(document).ready(function () {
	$('#db_name').on('change', function () {
		...
		window.location.href = "/java/dbtools?db_name=" + db_name;
	});
	$('#table_name').on('change', function () {
		var db_name = $('#db_name').val();
		var table_name = $(this).val();
		window.location.href = "/java/dbtools?db_name=" + db_name + "&table_name=" + table_name;
	});
	$('#changeTable').on('click', function () {
		...
		window.location.href = "/java/dbtools?db_name=" + db_name + "&table_name=" + table_name + "&object_name=" + object_name;
	});
});